    ...
    public List<BlogVO> selectByPage(BlogQuery blogQuery) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                BlogVO blogVO = new BlogVO(id, name, image, clickCount, content, typeId, status, deleted, createTime, updateTime, typeName);
                list.add(blogVO);
            }
    ...
    public Blog selectById(String id) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                Date createTime = resultSet.getTimestamp("create_time");
                Date updateTime = resultSet.getTimestamp("update_time");
                blog = new Blog(Integer.parseInt(id), name, image, clickCount, content, typeId, status, deleted, createTime, updateTime);
            }
        } catch (SQLException e) {
            throw new RuntimeException(e);
        } finally {
