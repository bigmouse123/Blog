...
//                            OutputStream outputStream = new FileOutputStream("D:/mypic/" + fileName);
...
//                            inputStream.close();
                            ...
                            fileName = uuid + "." + extension;
                            InputStream inputStream = fileItem.getInputStream();
                            OutputStream outputStream = new FileOutputStream("F:/mypic/" + fileName);
                            IOUtils.copy(inputStream, outputStream);
                            inputStream.close();
                            outputStream.close();
                            //删除临时文件
        ...
        JSONUtils.toJSON(resp, Result.ok("上传成功", fileName));
    }
}
